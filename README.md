...
- `/status` — статус Web Bridge: CDP, URL выделенного чата, **модель и режим
  Extended Thinking**, память; с кнопками:
  - **🆕 Новый чат** — создаёт новый выделенный чат Gemini и переключает бота на него
